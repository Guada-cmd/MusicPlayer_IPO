...
import com.example.musicplayer_ipo.Adaptadores.AdaptadorListaAlbum;
...
public class ventana_album extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ventana_album);
    ...
    private void inicializarDatos(){
        ...
        this.lstAlbum = findViewById(R.id.lstArtistas);
